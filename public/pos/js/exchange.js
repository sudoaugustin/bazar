...
$(document).ready(function () {
  ...
  $("input[name=submit]").click(function (e) {
    ...
    if (!amount.val()) amount.addClass("err");else if (isNaN(amount.val())) amount.addClass("err");else if (amount.val() < 50000) {
      amount.addClass("err");
      $(".errMsg").html("Minium withdraw amount is 50000Ks").addClass("visible");
    } else if (amount.val() > max) {
      $(".errMsg").html("Maximum withdraw amount is ".concat(max, "Ks")).addClass("visible");
    } else {
