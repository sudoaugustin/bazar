...
$(document).ready(function () {
  ...
  var monthly_chart = new apexcharts__WEBPACK_IMPORTED_MODULE_0__.default(document.querySelector('.total_sales #chart'), monthly_chart_options);
  monthly_chart.render();
  var session_chart = new apexcharts__WEBPACK_IMPORTED_MODULE_0__.default(document.querySelector(".store_session #chart"), store_session_chart);
  session_chart.render();
  var avg_chart = new apexcharts__WEBPACK_IMPORTED_MODULE_0__.default(document.querySelector(".average_value #chart"), avg_sale_options);
  avg_chart.render();
  $(".pp_img").click(function (e) {
    $(".kit").toggleClass("show");
  });
  $(".kit i").click(function (e) {
  ...
  axios.post("/management", {
    ...
    $(".total_sales .indicator").removeClass("bx-up-arrow-alt bx-down-arrow-alt bx-minus").html(html).addClass(classToAdd);
  ...
  axios.post("/management", {
    ...
    $(".store_session .visitor-indicator").removeClass("bx-up-arrow-alt bx-down-arrow-alt bx-minus").html(html).addClass(classToAdd);
    ...
    $(".store_session .subscriber-indicator").removeClass("bx-up-arrow-alt bx-down-arrow-alt bx-minus").html(html).addClass(classToAdd);
