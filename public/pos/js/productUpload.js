...
"use strict";
/*!*******************************************!*\
  !*** ./resources/js/pos/productUpload.js ***!
  \*******************************************/
...
$(document).ready(function () {
  $(".custom-select .option span").click(function (e) {
    var ele = e.delegateTarget,
        value = ele.innerHTML;
    $("input[name=category]").val(value);
    $(".custom-select .active").html(value + "<i class='bx bxs-down-arrow'></i>");
    $(".custom-select .option").fadeOut();
  });
  $(".custom-select .active").click(function (e) {
    $(".custom-select .option").css("display", "flex").hide().fadeIn();
  });
  $(".custom-select .option span:first-child").click();
  $(".spec .bxs-plus-square").click(function (e) {
    $(".spec").append("\n        <input type=\"text\" name=\"spec\" placeholder=\"Specification\">\n        ");
  });
  $(".size-btn").click(function (e) {
    var id = $(".size-root").length + 1 || 1,
        element = "<div id=".concat(id, " class=\"size-root\">\n            <input type=\"text\" name=\"size\"  placeholder=\"Enter size\">\n            <input type=\"text\" name=\"color\" placeholder=\"Enter color\">\n            <input type=\"text\" name=\"qty\"   placeholder=\"Enter quantity\">\n            <input type=\"text\" name=\"price\"   placeholder=\"Enter price in Ks\">\n            <div class=\"color-img\" id=").concat(id, ">\n               <h5>Min-3 photos</h5>\n               <input class=\"file\" type=\"file\" id=").concat(id, " style=\"display: none\" multiple>\n               <p class=\"upload-btn\" id=").concat(id, ">Upload Image</p>\n               <div class=\"imgs\" id=").concat(id, ">\n               </div>\n            </div>      \n           </div>");
    ...
    $(".file").change(function (e) {
      ...
      function _Main() {
        _Main = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee(file) {
          var img;
  ...
  $(".submit .create").click(function () {
    ...
    !category.val() ? category.addClass("err") : category.removeClass("err");
    !desc.val() ? desc.addClass("err") : desc.removeClass("err"); // specs.each((i,obj)=>{
    ...
    prices.each(function (i, obj) {
      !$(obj).val() || isNaN($(obj).val()) ? $(obj).addClass("err") : $(obj).removeClass("err");
    });
    ...
    imgs.each(function (i, obj) {
      var id = obj.id;
      $(obj).children().length < 3 ? $("#" + id + ".upload-btn").addClass("err") : $("#" + id + ".upload-btn").removeClass("err");
    });
    ...
    if (!$(".upload--root .err").length) {
      ...
      for (var i = 0; i < sizes.length; i++) {
        ...
        for (var j = 0; j < imgFiles[i].files.length; j++) {
          formData.append($(sizes[i]).val() + "" + $(colors[i]).val() + "" + j, imgFiles[i].files[j]);
        }
      }

      specs.each(function (i, obj) {
        if (i == 0) speciString += $(obj).val();else speciString += "," + $(obj).val();
      });
      ...
      axios.post("/product", formData).then(function (res) {
