...
$(document).ready(function () {
  $(".products--upload i.bx-plus").click(function (e) {
    ...
    axios.post("/management", {
      ...
      return $('.popover').hide().html(res.data).fadeIn();
    })["catch"](function (err) {
      return console.log(err.response);
    });
  });
  $('.item_card').click(function (e) {
    var p_id = e.delegateTarget.id;
    axios.post("/management", {
      p_id: p_id,
      page: "productById"
    }).then(function (res) {
      $(".popover").html(res.data);
      $(".checkout #price").on("input", function (e) {
        e.delegateTarget.style.width = (e.delegateTarget.value.length + 1) * 9 + 'px';
      });
      $(".item_view .right .checkout .size span").click(function (e) {
        ...
        $(".item_view .right .checkout .color img").click(function (e) {
          var ele = e.delegateTarget,
              name = ele.name,
          ...
          item.qty > 0 ? $(".item_view .right .checkout .qty span i.bx-minus").removeClass("disable") : $(".item_view .right .checkout .qty span i.bx-minus").addClass("disable");
          $(".item_view .left").html("");
          ...
          $(ele).addClass("active");
          $(".item_view .left img").click(function (e) {
            var ele = e.delegateTarget,
                src = ele.src;
      ...
      $(".item_view .bx-x").click(function (e) {
        $(".kit i:first-child").click();
      });
      $(".item_view .right .checkout .qty span i.bx-plus").click(function (e) {
        var maxQty = parseInt($(".available").html());
        var qty = parseInt($(".qtyC").html());
        $(".item_view .right .checkout .qty span i.bx-minus").removeClass("disable");
        qty++;
        parseInt($(".qtyC").html(qty));
      });
      $(".item_view .right .checkout .qty span i.bx-minus").click(function (e) {
        var qty = parseInt($(".qtyC").html());
      ...
      $(".item_view .right .checkout .update_product").click(function (e) {
        ...
        axios.put("/product/" + id, item).then(function (res) {
          $(".item_view .right .checkout .update_product").html("Updated!");
          setTimeout(function () {
            return $(".item_view .right .checkout .update_product").html("Update product");
          }, 1500);
        })["catch"](function (err) {
          return console.log(err.response);
        });
      });
      $(".item_view .right .checkout .drop_product").click(function (e) {
        var id = e.delegateTarget.id;
        axios["delete"]("/product/" + id).then(function (res) {
