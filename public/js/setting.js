...
$(document).ready(function (e) {
  ...
  $("#save_userinfo").click(function (e) {
    ...
    if (phone.val().length > 0) {
      ...
      if (tel.length > 11 || tel.length < 8 || isNaN(tel)) {
        ...
        phone.parent().addClass("err");
        $("label[for=phone].msg").html("Enter phone number only start with 09");
      } else {
    ...
    if (!$(".textField.err").length) {
      ...
      axios.post("/updateUser", formData).then(function (res) {
