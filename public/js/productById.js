...
$(document).ready(function () {
  $(".item_view .right .checkout .size span").click(function (e) {
    ...
    for (var item in data) {
      $(".item_view .right .checkout .color").append("<img class=\"w-14 rounded-md\" src=".concat("/storage/products/" + data[item].img[0], " />"));
    }
    ...
    $(".item_view .right .checkout .color img").click(function (e) {
      ...
      if (item.qty === 1) $(".item_view .right .checkout .qty span i.bx-plus").addClass("disable");else $(".item_view .right .checkout .qty span i.bx-plus").removeClass("disable");
      $(".item_view .left").html("");
  ...
  $(".item_view .middle .title>span:last-child").click(function (e) {
    $(".item_view .middle .title span:last-child i").toggleClass("bx-heart bxs-heart active");
    var likeEle = $(".item_view .middle .title>span:last-child span");
  ...
  $(".item_view .right .checkout .add_to_cart").click(function (e) {
    ...
    if (Object.keys(cart).length) $("nav ul li#cart").addClass("noti");else $("nav ul li#cart").removeClass("noti");
  });
});
})();
