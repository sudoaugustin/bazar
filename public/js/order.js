...
$(document).ready(function () {
  $(".order_title span").click(function (e) {
    var target = e.target;
    $(".order_title span.active").removeClass("active");
    $(".order_title span#" + target.id).addClass("active");
    axios.get("order/type:" + target.id).then(function (res) {
      $("table.order").html(res.data);
      $('.bx-dots-horizontal-rounded').click(function (e) {
        axios.get("order/id:" + e.target.id).then(function (res) {
          var popover = $(".popover");
          popover.css("display", "flex").hide().fadeIn().html(res.data);
          $(".voucher .bx-x").click(function () {
            popover.fadeOut();
          });
        });
      });
