...
$(document).ready(function () {
  ...
  $(".cart_item span i.bx-x").click(function (e) {
    ...
    var total_price = calc_price(items);
    $("#total_price").html("Total:".concat(total_price, " K"));
  ...
  $("input[type=button]").click(function () {
    var payment_contact = $("input[name=payment_contact]"),
        payment_method = $(".payments p.active"),
        address_info = $("input[name=address]"),
        items = JSON.parse(sessionStorage.getItem("itm_in_cart"));
    payment_contact.val() ? payment_contact.removeClass("err") : payment_contact.addClass("err");
    address_info.val() ? address_info.removeClass("err") : address_info.addClass("err");
    ...
    if (!$("input.err").length) {
      ...
      axios.post("order", {
        ...
        $(".popover").fadeOut().html(html).addClass("show");
        $(".success_model .done").click(function (e) {
